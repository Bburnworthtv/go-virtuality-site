  ...
  return (
    <>
      <section className="page-band">
        <div className="mx-auto max-w-7xl px-5 pb-10 pt-16 md:px-8 md:pb-14 md:pt-24">
        <div className="grid gap-10 md:grid-cols-[1fr_1fr]">
          <div className="max-w-2xl">
            <p className="eyebrow">{project.category}</p>
            <h1 className="mt-5 font-display text-5xl leading-[0.95] tracking-editorial md:text-7xl">
              {project.title}
            </h1>
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-5 py-8 md:grid-cols-3 md:px-8 md:py-14">
